...
/**
 * @file
 * Definition of Drupal\ga_partner_category_ref_filter\Plugin\views\filter\RelatedContentTitles.
 */
namespace Drupal\ga_partner_category_ref_filter\Plugin\views\filter;
 ...
 *
 * @ViewsFilter("ga_partner_category_ref_filter_related_content_titles")
 */
class RelatedPartnerCategory extends ManyToOne {
    /**
     * {@inheritdoc}
     */
